...
def compute_manipulate_reward(seq, actions, disc, loss=None, label=None, activation=None,ignore_far_sim=True,temp_dist_thre=20, use_gpu=False, device=None, save_seq=None):
    """
